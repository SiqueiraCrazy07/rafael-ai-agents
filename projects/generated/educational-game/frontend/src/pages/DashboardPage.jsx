...
export function DashboardPage() {
  const features = ["core mechanic","3 levels","score feedback","learning summary"].map((title) => ({ title, detail: "Generated MVP surface" }));
  return (
    <section>
      <PageHeader kicker="Prototype dashboard" title="Educational Game" action={<button className="button" type="button">Readonly preview</button>} />
      <div className="grid">
        <div className="span-3"><MetricCard title="Readiness" value="V1" detail="rendered prototype" tone="success" /></div>
        <div className="span-3"><MetricCard title="Routes" value="10" detail="functional hash nav" /></div>
